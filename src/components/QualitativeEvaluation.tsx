...
const missions: Mission[] = [
  {
    ...
    items: [
      {
        id: "1.1",
        name: "ผลสำเร็จของรายวิชาที่รับผิดชอบ (สกอ.2.6)",
        levels: [
          { level: 1, description: "มีการส่ง มคอ.3/มคอ.4 ก่อนเปิดภาคเรียน", score: 150 },
          { level: 2, description: "มีการส่ง มคอ.5/มคอ.6 หลังสิ้นภาคเรียน", score: 175 },
          { level: 3, description: "มีเอกสารประกอบการสอนที่เน้นผู้เรียนเป็นสำคัญ", score: 200 },
          { level: 4, description: "มีการปรับปรุงเอกสารประกอบการสอนและนำผลประเมินมาปรับปรุง", score: 225 },
          { level: 5, description: "มีการทำวิจัยในชั้นเรียนและนำผลไปปรับปรุงการสอน", score: 250 },
        ],
        result: { level: 4, score: 225 },
        evidence: "เอกสารหมายเลข 1.4.1-1.4.3, 1.5",
      },
      {
        id: "1.3",
        ...
        levels: [
          ...
          { level: 3, description: "ประยุกต์การใช้สื่อให้เป็นนวัตกรรม เช่น e-learning, CAI", score: 200 },
      ...
      {
        id: "1.5.2",
        name: "ผลสำเร็จของการเป็นที่ปรึกษาปริญญานิพนธ์/โครงงาน ระดับปริญญาตรี",
        levels: [
      ...
      {
        id: "1.3b",
        name: "ผลสำเร็จของผลการประเมินการสอน (สกอ.2.6, 3.2)",
        levels: [
  ...
  },
  {
    ...
    items: [
      {
        id: "2.1",
        name: "ผลสำเร็จของการเสนอขอโครงการวิจัย/งานสร้างสรรค์ที่ได้รับทุน (สกอ.4.2, สมศ.5)",
        levels: [
          { level: 1, description: "เสนอโครงการต่อหน่วยงาน", score: 50 },
          { level: 2, description: "ได้รับอนุมัติจากงบประมาณภายในมหาวิทยาลัย", score: 75 },
          { level: 3, description: "ได้รับอนุมัติจากงบประมาณภายนอกมหาวิทยาลัย", score: 100 },
          { level: 4, description: "รายงานความก้าวหน้าและขอเบิกงวดที่ 2", score: 125 },
          { level: 5, description: "ดำเนินโครงการแล้วเสร็จ", score: 150 },
        ],
  ...
  },
  {
    ...
    items: [
      {
        id: "3.1",
        name: "ผลสำเร็จของการเสนอขอโครงการบริการวิชาการแก่สังคม (สกอ.5.1, สมศ.8)",
        levels: [
          { level: 1, description: "เสนอโครงการต่อหน่วยงาน", score: 60 },
          { level: 2, description: "โครงการได้รับการอนุมัติ", score: 70 },
          { level: 3, description: "ได้รับงบประมาณภายนอกมหาวิทยาลัย", score: 80 },
      ...
      {
        id: "3.2",
        name: "ผลสำเร็จของการบูรณาการโครงการบริการวิชาการ (สกอ.5.1, สมศ.8)",
        levels: [
          ...
          { level: 3, description: "นำโครงการฯ ขยายผลสู่การปรับปรุงรายวิชา", score: 80 },
          { level: 4, description: "นำโครงการฯ ขยายผลสู่การเปิดรายวิชาใหม่", score: 90 },
          { level: 5, description: "นำโครงการฯ ไปต่อยอดสู่หนังสือหรือตำรา", score: 100 },
        ],
        result: { level: 1, score: 60 },
        evidence: "เอกสารหมายเลข 3.1.1 - บูรณาการกับการเรียนรายวิชาการโปรแกรมคอมพิวเตอร์ ใบงานที่ 8 สัปดาห์ที่ 14",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        levels: [
          ...
          { level: 2, description: "เผยแพร่กิจกรรมต่อสาธารณชน", score: 70 },
        ...
        evidence: "เอกสารหมายเลข 4.1 - เผยแพร่ Facebook มหาวิทยาลัย",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "5.1",
        name: "การปฏิบัติงานตามคำสั่งของคณะ นอกเหนือพันธกิจหลัก",
        levels: [
        ...
        evidence: "เอกสารหมายเลข 5.1 - ดำเนินการเสร็จตามคำสั่ง",
      },
      {
        id: "5.2",
        name: "การปฏิบัติงานตามคำสั่งของมหาวิทยาลัย นอกเหนือพันธกิจหลัก",
        levels: [
          { level: 1, description: "รับทราบ", score: 60 },
          { level: 2, description: "ดำเนินการได้ร้อยละ 50", score: 70 },
          { level: 3, description: "ดำเนินการได้ร้อยละ 80", score: 80 },
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                ...
                { name: "3. ด้านการบริการทางวิชาการแก่สังคม", raw: 240, full: 200, scaled: 2.40 },
                { name: "4. ด้านการทำนุบำรุงศิลปวัฒนธรรม", raw: 130, full: 200, scaled: 1.30 },
                { name: "5. ด้านบริหารจัดการ", raw: 160, full: 300, scaled: 1.60 },
              ].map((row, i) => (
